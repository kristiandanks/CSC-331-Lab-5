        ...
        while (running)
        {
            ...
            switch (addRemoveSelection)
            {
                ...
                case 2:
                    ...
                    for (HouseholdItem item: householdItemInventory){
                        System.out.println("------------------------------------------------------------");
                        System.out.println(item.getName());
                        System.out.println(item.getBrand());
                        System.out.println(item.getPrice());
                    ...
                    int totalCost = 0;
                    ArrayList<FoodItem> foodItemInventoryTemp = new ArrayList<>(foodItemInventory);
                    ArrayList<ElectronicsItem> electronicsItemInventoryTemp = new ArrayList<>(electronicsItemInventory);
                    ArrayList<ClothingItem> clothingItemInventoryTemp = new ArrayList<>(clothingItemInventory);
                    ArrayList<HouseholdItem> householdItemInventoryTemp = new ArrayList<>(householdItemInventory);
                            ...
                            case 1: // Food
                                ...
                                for (int i = 0; i < foodItemInventoryTemp.size(); i++) {
                                    if (foodItemInventoryTemp.get(i).getName().equals(sellName)) {
                                        ...
                                        found = true;
                                        FoodItem item = foodItemInventoryTemp.get(i);
                            ...
                            case 2: // Electronics
                                ...
                                for (int i = 0; i < electronicsItemInventoryTemp.size(); i++) {
                                    if (electronicsItemInventoryTemp.get(i).getName().equals(sellName)) {
                                        ...
                                        shoppingCart[itemNumber-1] = sellName;
                                        found = true;
                                        ElectronicsItem item = electronicsItemInventoryTemp.get(i);
                            ...
                            case 3: //Clothing
                                ...
                                for (int i = 0; i < clothingItemInventoryTemp.size(); i++) {
                                    if (clothingItemInventoryTemp.get(i).getName().equals(sellName)) {
                                        ...
                                        shoppingCart[itemNumber-1] = sellName;
                                        found = true;
                                        ClothingItem item = clothingItemInventoryTemp.get(i);
                                        totalCost += item.getPrice() + item.getPrice()*.07;
                            ...
                            case 4: //Household
                                ...
                                for (int i = 0; i < householdItemInventoryTemp.size(); i++) {
                                    if (householdItemInventoryTemp.get(i).getName().equals(sellName)) {
                                        ...
                                        shoppingCart[itemNumber-1] = sellName;
                                        found = true;
                                        HouseholdItem item = householdItemInventory.get(i);
                                        totalCost += item.getPrice() + item.getPrice()*.07;
                                        clothingItemInventoryTemp.remove(i);
                                        break;
                                    }
